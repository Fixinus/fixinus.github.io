...
(() =>
{
  ...
  const MESSAGES = {
    ...
    sv: {
      ...
      'pricing.pc.p3': 'fr. 40 €',
      'pricing.pc.r4': 'Programunderhåll och borttagning av skadeprogram',
      ...
      'pricing.pc.note2': 'Felsökning utförs i högst tre timmar utan separat överenskommelse. Om felet kräver en mer omfattande utredning meddelar vi dig och kommer alltid överens om fortsättningen innan arbetet fortsätter.',
      'pricing.visits.title': 'Fjärrsupport & besök',
      'pricing.visits.r1': 'Fjärrsupport',
      'pricing.visits.p1': '20 € / 30 min',
      'pricing.visits.r2': 'Besök på plats (t.ex. Wi-Fi, TV och skrivare)',
      ...
      'pricing.console.r1': 'Rengöring, dammborttagning och byte av kylpasta (ej PS5)',
    ...
    /* ========== FINNISH ========== */
      ...
      'pricing.pc.r4': 'Ohjelmallinen huolto ja haittaohjelmien poisto',
      'pricing.pc.p4': '50–100 €',
      ...
      'pricing.pc.note2': 'Vianmääritystä tehdään enintään kolme tuntia ilman erillistä sopimista. Jos vika vaatii tätä laajempaa selvitystä, ilmoitamme siitä ja sovimme jatkosta aina ennen työn jatkamista.',
      'pricing.visits.title': 'Etätuki ja käynnit',
      'pricing.visits.r1': 'Etätuki',
      'pricing.visits.p1': '20 € / 30 min',
      'pricing.visits.r2': 'Käynti paikan päällä (esim. Wi-Fi, TV ja tulostimet)',
      'pricing.visits.p2': '20 € + 70 €/h',
    ...
    en: {
      ...
      'pricing.pc.r4': 'Software tune-up and malware removal',
      'pricing.pc.p4': '€50–100',
      ...
      'pricing.pc.note2': 'Diagnostics is limited to three hours unless separately agreed. If the fault requires a more extensive investigation, we\'ll let you know and always agree on how to proceed before continuing the work.',
      'pricing.visits.title': 'Remote support & visits',
      'pricing.visits.r1': 'Remote support',
      'pricing.visits.p1': '€20 / 30 min',
      'pricing.visits.r2': 'On-site visit (e.g. Wi-Fi, TV and printers)',
      'pricing.visits.p2': '€20 + €70/h',
      ...
      'pricing.console.r1': 'Cleaning, dust removal and thermal paste replacement (excl. PS5)',
      'pricing.console.p1': '€100',
