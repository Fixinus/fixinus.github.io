...
(() =>
{
  ...
  const MESSAGES = {
    ...
    sv: {
      ...
      'pricing.lead': 'Alla priser inkluderar moms 25,5 %. Reservdelar debiteras separat och avtalas alltid innan de beställs. Efter felsökningen får du alltid en prisuppskattning för reparationen, och arbetet fortsätter först när du har godkänt den. Om enheten konstateras vara oreparerbar debiteras endast felsökningen.',
      'pricing.pc.title': 'Datorer & bärbara datorer',
      'pricing.pc.r1': 'Felsökning (högst 150 €)',
      'pricing.pc.p1': '50 €/h',
      'pricing.pc.r2': 'Ren installation av Windows eller macOS, uppdateringar och drivrutiner',
      'pricing.pc.p2': '70 €',
      'pricing.pc.r3': 'Överföring eller återställning av filer i samband med installation',
      'pricing.pc.p3': 'fr. 40 €',
      'pricing.pc.r4': 'Underhåll och borttagning av skadeprogram',
      'pricing.pc.p4': '50–100 €',
      'pricing.pc.r12': 'Rengöring och dammborttagning',
      'pricing.pc.p12': '50 €',
      'pricing.pc.r13': 'Byte av kylpasta',
      'pricing.pc.p13': 'fr. 50 €',
      'pricing.pc.r14': 'Årsservice (rengöring, uppdateringar och konditionsrapport)',
      'pricing.pc.p14': '90 €',
      'pricing.pc.r5': 'Batteribyte, bärbar dator (ej Apple)',
      'pricing.pc.p5': 'fr. 60 € + delar',
      'pricing.pc.r6': 'Batteribyte, MacBook',
      'pricing.pc.p6': 'fr. 150 € + delar',
      'pricing.pc.r7': 'Batteribyte, limmat batteri',
      'pricing.pc.p7': 'fr. 250 € + delar',
      'pricing.pc.r8': 'Skärmbyte, bärbar dator',
      'pricing.pc.p8': 'fr. 100 € + delar',
      'pricing.pc.r9': 'SSD-uppgradering och dataöverföring',
      'pricing.pc.p9': 'fr. 80 € + delar',
      'pricing.pc.r15': 'Uppgradering av RAM-minne',
      'pricing.pc.p15': 'fr. 40 € + delar',
      'pricing.pc.r10': 'Montering av stationär dator, inkl. installation av operativsystem',
      'pricing.pc.p10': 'fr. 150 €',
      'pricing.pc.r11': 'Övrigt service- och installationsarbete',
      'pricing.pc.p11': '70 €/h',
      'pricing.pc.note': 'Windows installeras med datorns egen licens, som på de flesta datorer överförs automatiskt till den nya installationen. Om datorn behöver en ny licens berättar vi det och kommer överens om anskaffningen separat.',
      'pricing.visits.title': 'Fjärrsupport & besök',
      'pricing.visits.r1': 'Fjärrsupport',
      'pricing.visits.p1': '20 € / 30 min',
      'pricing.visits.r2': 'Besök på plats (t.ex. Wi-Fi-nät och skrivare)',
      'pricing.visits.p2': '20 € + 70 €/h',
      'pricing.visits.r3': 'Resekostnader (returresan debiteras inte)',
      'pricing.visits.p3': '2 €/km',
      'pricing.visits.r4': 'Hämtning och återlämning av enhet inom 10 km från Borgå torg',
      'pricing.visits.p4': 'kostnadsfritt',
      'pricing.visits.note': 'Brådskande arbeten utanför öppettiderna: tillägg +50 % (mån–fre), +75 % (lör) och +100 % (sön).',
      'pricing.data.title': 'Dataräddning',
      'pricing.data.r1': 'Filåterställning, mjukvarufel',
      'pricing.data.p1': 'fr. 100 €',
      'pricing.data.note': 'Den inledande bedömningen och prisuppskattningen är kostnadsfria, och vi debiterar endast för en lyckad återställning. Det exakta priset bekräftas alltid innan arbetet påbörjas. Mer krävande fall, som fysiskt skadade diskar, bedöms från fall till fall och vid behov hänvisar vi dig till en specialistfirma.',
      'pricing.console.title': 'Spelkonsoler',
      'pricing.console.r1': 'Rengöring, dammborttagning och byte av kylpasta',
      'pricing.console.p1': '100 €',
      'pricing.console.r2': 'PS5-rengöring och byte av flytande metall',
      'pricing.console.p2': 'fr. 150 €',
      'pricing.other.title': 'Övriga arbeten',
      'pricing.other.r1': 'Ibruktagning av ny telefon och dataöverföring',
      'pricing.other.p1': 'fr. 50 €',
      ...
      'pricing.other.note': 'Felsökning utförs i högst tre timmar utan separat överenskommelse. Om felet kräver en mer omfattande utredning meddelar vi dig och kommer alltid överens om fortsättningen innan arbetet fortsätter.',
    ...
    /* ========== FINNISH ========== */
      ...
      'pricing.lead': 'Kaikki hinnat sisältävät arvonlisäveron 25,5 %. Varaosat veloitetaan erikseen ja niistä sovitaan aina ennen tilaamista. Vianmäärityksen jälkeen saat aina korjauksesta hinta-arvion, ja työ jatkuu vasta kun olet sen hyväksynyt. Jos laite todetaan korjauskelvottomaksi, veloitetaan vain vianmääritys.',
      'pricing.pc.title': 'Tietokoneet ja kannettavat',
      'pricing.pc.r1': 'Vianmääritys (enintään 150 €)',
      'pricing.pc.p1': '50 €/h',
      'pricing.pc.r2': 'Windowsin tai macOS:n asennus puhtaalta pöydältä, päivitykset ja ajurit',
      'pricing.pc.p2': '70 €',
      'pricing.pc.r3': 'Tiedostojen siirto tai palautus asennuksen yhteydessä',
      'pricing.pc.p3': 'alk. 40 €',
      'pricing.pc.r4': 'Huolto ja haittaohjelmien poisto',
      'pricing.pc.p4': '50–100 €',
      'pricing.pc.r12': 'Puhdistus ja pölynpoisto',
      'pricing.pc.p12': '50 €',
      'pricing.pc.r13': 'Lämpötahnan vaihto',
      'pricing.pc.p13': 'alk. 50 €',
      'pricing.pc.r14': 'Vuosihuolto (puhdistus, päivitykset ja kuntoraportti)',
      'pricing.pc.p14': '90 €',
      'pricing.pc.r5': 'Kannettavan akunvaihto (ei Apple)',
      'pricing.pc.p5': 'alk. 60 € + osat',
      'pricing.pc.r6': 'Akunvaihto, MacBook',
      'pricing.pc.p6': 'alk. 150 € + osat',
      'pricing.pc.r7': 'Akunvaihto, liimattu akku',
      'pricing.pc.p7': 'alk. 250 € + osat',
      'pricing.pc.r8': 'Kannettavan näytönvaihto',
      'pricing.pc.p8': 'alk. 100 € + osat',
      'pricing.pc.r9': 'SSD-päivitys ja tiedonsiirto',
      'pricing.pc.p9': 'alk. 80 € + osat',
      'pricing.pc.r15': 'RAM-muistin päivitys',
      'pricing.pc.p15': 'alk. 40 € + osat',
      'pricing.pc.r10': 'Pöytäkoneen kokoonpano, sis. käyttöjärjestelmän asennuksen',
      'pricing.pc.p10': 'alk. 150 €',
      'pricing.pc.r11': 'Muu huolto- ja asennustyö',
      'pricing.pc.p11': '70 €/h',
      'pricing.pc.note': 'Windowsin asennus tehdään koneen omalla lisenssillä, joka useimmissa koneissa siirtyy uuteen asennukseen automaattisesti. Jos kone tarvitsee uuden lisenssin, kerromme siitä ja sovimme hankinnasta erikseen.',
      'pricing.visits.title': 'Etätuki ja käynnit',
      'pricing.visits.r1': 'Etätuki',
      'pricing.visits.p1': '20 € / 30 min',
      'pricing.visits.r2': 'Käynti paikan päällä (esim. Wi-Fi-verkot ja tulostimet)',
      'pricing.visits.p2': '20 € + 70 €/h',
      'pricing.visits.r3': 'Matkakulut (paluumatkaa ei veloiteta)',
      'pricing.visits.p3': '2 €/km',
      'pricing.visits.r4': 'Laitteen nouto ja palautus 10 km säteellä Porvoon torilta',
      'pricing.visits.p4': 'maksuton',
      'pricing.visits.note': 'Kiireelliset työt aukioloaikojen ulkopuolella: lisähinta +50 % (ma–pe), +75 % (la) ja +100 % (su).',
      'pricing.data.title': 'Tietojen palautus',
      'pricing.data.r1': 'Tiedostojen palautus, ohjelmalliset viat',
      ...
      'pricing.console.r1': 'Puhdistus, pölynpoisto ja lämpötahnan vaihto',
      'pricing.console.p1': '100 €',
      'pricing.console.r2': 'PS5 puhdistus ja nestemetallin vaihto',
      'pricing.console.p2': 'alk. 150 €',
      'pricing.other.title': 'Muut työt',
      'pricing.other.r1': 'Uuden puhelimen käyttöönotto ja tiedonsiirto',
      'pricing.other.p1': 'alk. 50 €',
      ...
      'pricing.other.note': 'Vianmääritystä tehdään enintään kolme tuntia ilman erillistä sopimista. Jos vika vaatii tätä laajempaa selvitystä, ilmoitamme siitä ja sovimme jatkosta aina ennen työn jatkamista.',
    ...
    en: {
      ...
      'pricing.lead': 'All prices include 25.5% VAT. Spare parts are charged separately and always agreed on before ordering. After diagnostics you always get a price estimate for the repair, and work continues only once you have approved it. If the device turns out to be beyond repair, you only pay for the diagnostics.',
      'pricing.pc.title': 'Computers & laptops',
      'pricing.pc.r1': 'Diagnostics (capped at €150)',
      'pricing.pc.p1': '€50/h',
      'pricing.pc.r2': 'Clean Windows or macOS installation, updates and drivers',
      'pricing.pc.p2': '€70',
      'pricing.pc.r3': 'File transfer or restore with an installation',
      'pricing.pc.p3': 'from €40',
      'pricing.pc.r4': 'Tune-up and malware removal',
      'pricing.pc.p4': '€50–100',
      'pricing.pc.r12': 'Cleaning and dust removal',
      'pricing.pc.p12': '€50',
      'pricing.pc.r13': 'Thermal paste replacement',
      'pricing.pc.p13': 'from €50',
      'pricing.pc.r14': 'Annual service (cleaning, updates and health report)',
      'pricing.pc.p14': '€90',
      'pricing.pc.r5': 'Laptop battery replacement (non-Apple)',
      'pricing.pc.p5': 'from €60 + parts',
      'pricing.pc.r6': 'Battery replacement, MacBook',
      'pricing.pc.p6': 'from €150 + parts',
      'pricing.pc.r7': 'Battery replacement, glued-in battery',
      'pricing.pc.p7': 'from €250 + parts',
      'pricing.pc.r8': 'Laptop screen replacement',
      'pricing.pc.p8': 'from €100 + parts',
      'pricing.pc.r9': 'SSD upgrade and data transfer',
      'pricing.pc.p9': 'from €80 + parts',
      'pricing.pc.r15': 'RAM upgrade',
      'pricing.pc.p15': 'from €40 + parts',
      'pricing.pc.r10': 'Desktop PC build, incl. operating system installation',
      'pricing.pc.p10': 'from €150',
      'pricing.pc.r11': 'Other service and installation work',
      'pricing.pc.p11': '€70/h',
      'pricing.pc.note': 'Windows is installed with the computer\'s own license, which on most machines carries over to the new installation automatically. If the machine needs a new license, we\'ll tell you and agree on it separately.',
      'pricing.visits.title': 'Remote support & visits',
      'pricing.visits.r1': 'Remote support',
      'pricing.visits.p1': '€20 / 30 min',
      'pricing.visits.r2': 'On-site visit (e.g. Wi-Fi networks and printers)',
      'pricing.visits.p2': '€20 + €70/h',
      'pricing.visits.r3': 'Travel costs (return trip not billed)',
      'pricing.visits.p3': '€2/km',
      'pricing.visits.r4': 'Device pickup & return within 10 km of Porvoo market square',
      'pricing.visits.p4': 'free',
      'pricing.visits.note': 'Urgent work outside business hours: surcharge of +50% (Mon–Fri), +75% (Sat) and +100% (Sun).',
      'pricing.data.title': 'Data recovery',
      'pricing.data.r1': 'File recovery, software faults',
      'pricing.data.p1': 'from €100',
      'pricing.data.note': 'The initial assessment and price estimate are free, and we only charge for a successful recovery. The exact price is always confirmed before work begins. More demanding cases, such as physically damaged drives, are assessed case by case and referred to a specialist when needed.',
      'pricing.console.title': 'Game consoles',
      'pricing.console.r1': 'Cleaning, dust removal and thermal paste replacement',
      'pricing.console.p1': '€100',
      'pricing.console.r2': 'PS5 cleaning and liquid metal replacement',
      'pricing.console.p2': 'from €150',
      'pricing.other.title': 'Other work',
      'pricing.other.r1': 'New phone setup and data transfer',
      'pricing.other.p1': 'from €50',
      ...
      'pricing.other.note': 'Diagnostics is limited to three hours unless separately agreed. If the fault requires a more extensive investigation, we\'ll let you know and always agree on how to proceed before continuing the work.',
